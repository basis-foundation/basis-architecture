...
basis-producer Phase 2A evidence retention         Implemented — merged (repository
        ...
        ↓
basis-producer Phase 2B reference lifecycle        Next — not yet implemented
        (reference_id minting, AdapterEvidenceReference assembly)
        ↓
basis-producer Phase 3 gateway client              Future
