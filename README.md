...
- [ADR-0008](docs/adr/0008-producer-workload-authentication-and-admission.md) — proposed producer-to-gateway mTLS authentication and admission model; no implementation work in `basis-gateway`, `basis-identity`, `basis-adapters`, `basis-core`, or `basis-schemas` is authorized by this document alone
