...
- [ADR-0010](docs/adr/0010-establish-basis-producer-as-operation-producer-runtime.md) — Proposed, not yet Accepted; establishes `basis-producer` (repository `basis-foundation/basis-producer`, public, Python package `basis_producer`) as the permanent operation-producer-runtime repository and component, resolving the repository-placement decision gate `operation-producer-and-execution-boundary.md` §11 and the bounded implementation plan's §30 left open; does not create the repository, does not implement anything, and does not authorize protocol execution
...
- [ADR-0010](docs/adr/0010-establish-basis-producer-as-operation-producer-runtime.md) — Proposed, not yet Accepted; establishes `basis-producer` as the permanent operation-producer-runtime repository and component; no implementation work in any repository, including creation of `basis-producer` itself, is authorized until formal acceptance
