...
- [`docs/architecture/adapter-evidence-construction-semantics.md`](docs/architecture/adapter-evidence-construction-semantics.md) — architecture-planning for adapter evidence material, canonicalization, digest, and reference-construction ownership between `basis-adapters` and the future operation-producer runtime, proposed by [ADR-0007](docs/adr/0007-adapter-evidence-construction.md); no implementation work is authorized by this document alone
