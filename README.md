...
- [ADR-0008](docs/adr/0008-producer-workload-authentication-and-admission.md) — accepted; `basis-gateway` Phase 1B.1 and Phase 1B.2 implementation is merged, Phase 1B.3 remains in progress, and the broader bounded producer reference slice remains incomplete; answers the operation-producer-and-execution-boundary document's Stage 4 decision gate by selecting mutual TLS as the first normative producer-to-gateway workload-authentication profile, separating authentication from gateway admission and producer identity from authorization subject identity, and authorizing (without itself implementing) a bounded producer reference slice
...
- [ADR-0009](docs/adr/0009-trusted-producer-mtls-ingress-and-gateway-certificate-handoff.md) — accepted trusted mTLS ingress and gateway certificate-handoff topology; `basis-gateway` Phase 1B.1 and Phase 1B.2 implementation is merged, Phase 1B.3 remains in progress
