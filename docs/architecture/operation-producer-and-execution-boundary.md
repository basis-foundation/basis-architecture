...
basis-producer
    ...
    gateway submission
    (established by ADR-0010, Accepted; repository not yet created — the
    logical operation-producer role itself remains distinct from this
    named implementation; see §11)
