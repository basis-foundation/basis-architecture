...
basis-producer
    ...
    evidence-retention foundation and Phase 2B reference-lifecycle
    responsibility both implemented — the logical operation-producer
    role itself remains distinct from this named implementation;
    see §11)
