...
| `basis-producer` | Operation-producer runtime | Evidence retention, reference-lifecycle management, producer workload credential custody, authenticated gateway submission (established by [ADR-0010](../adr/0010-establish-basis-producer-as-operation-producer-runtime.md); Accepted; repository exists; Phase 2A evidence-retention foundation, Phase 2B reference-lifecycle responsibility, and Phase 3 authenticated gateway client all implemented; adapter composition (Phase 4) and later phases unimplemented) |
