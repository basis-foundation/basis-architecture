...
| `basis-producer` | Operation-producer runtime | Evidence retention, reference-lifecycle management, producer workload credential custody, authenticated gateway submission (established by [ADR-0010](../adr/0010-establish-basis-producer-as-operation-producer-runtime.md); Accepted; repository exists; Phase 2A evidence-retention foundation and Phase 2B reference-lifecycle responsibility both implemented; gateway submission (Phase 3) and later phases unimplemented) |
