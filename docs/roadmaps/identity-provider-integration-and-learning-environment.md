...
- **Step 19 (operation normalization through a producer runtime).** `basis-producer` now exists and its Phase 2A evidence-retention foundation is implemented and merged. Reference-lifecycle assembly (Phase 2B) and adapter orchestration remain unimplemented, per [`docs/architecture/operation-producer-and-execution-boundary.md`](../architecture/operation-producer-and-execution-boundary.md)'s Stages 4 and 5.
...
| Operation normalization via a producer runtime (step 19) | [`docs/architecture/operation-producer-and-execution-boundary.md`](../architecture/operation-producer-and-execution-boundary.md) §13 Stages 4–5; [ADR-0010](../adr/0010-establish-basis-producer-as-operation-producer-runtime.md) | Permanent component (`basis-producer`) established, `Accepted`; repository exists, Phase 2A (evidence-retention foundation) implemented; reference lifecycle and later phases not yet implemented |
